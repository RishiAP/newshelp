...
export async function POST(req: NextRequest) {
    try {
        ...
        const email_sent=await sendEmail(`"News Help" <${process.env.SMTP_NOREPLY}>`,data.email,"Create your News Help account",`Your email has been registered with us. Please click on the link to continue http://${process.env.NEXT_PUBLIC_DOMAIN}/admin-signup?token=${token}`,emailHtml);
